...
const About = () => {
    ...
    return (
        <section id="body">
            ...
            <p className="about-paragraph">Hey there! Thanks for taking the time to reading about me! I hope the person reading this is in a good state of health mentally, physically, and spiritually. I am a Software Engineering graduate from McMaster University.</p>
